...
const handleDropdownItemClickParent = (clickedItem) => {
  ...
  if (clickedItem.title === "Download as Pdf") {
    ...
    // router.push(`/pdf/generate/${clientId.value}/${busin=essId.value}/${invoiceId}`);
  ...
  <div class="get" v-else>
    ...
    <section class="max-w-[95%] mt-4 ml-4 bg-white">
      <form @submit.prevent class="p-4">
            ...
            >
              <span
                ...
                :class="{
                  ...
                  'bg-orange-300 text-white text-[12px]':
                    invoice.formData.paymentStatus === 'Unpaid',
                  'bg-[#878787] text-white text-[12px]':
        ...
        <div class="flex mb-8 mt-4">
          <div class="flex flex-col mb-2">
            ...
            <div class="justify-left rounded-2">
              ...
              <span class="2xl:mr-32 xl:mr-10">
                {{ invoice.formData.sender.firstName }}</span
              ><br />
              <span class="mr-2 2xl:mr-[150px] xl:mr-[110px]">
                {{ invoice.formData.sender.lastName }}</span
              ><br />
              <span class="mr-8 2xl:mr-[160px] xl:mr-[105px]">{{
                invoice.formData.sender.state
              }}</span
              ><br />
              <span class="2xl:mr-[170px] xl:ml-1">{{
                invoice.formData.sender.address1
              }}</span
              ><br />
        ...
        <hr />
        <br />
        <div class="flex lg:flex-row 2xl:flex-row md:flex-col">
          <div class="w-full">
        ...
        <div class="flex flex-col max-w-full items-end">
          <div class="flex justify-around w-[80%] 2xl:w-[100%] items-end">
            <div class="text-black flex flex">
              <span class="px-[4px] py-[10px] border-black text-[12px] rounded">
                SubTotal
              </span>
            </div>
            <div class="pb-2 pt-4">
