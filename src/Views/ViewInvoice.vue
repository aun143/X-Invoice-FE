              ...
              <div class="p-4 md:p-5">
                  <form @submit.prevent="submitPassword" class="space-y-4">
                      <div class="relative">
                         ...
                         <div class="bg-white">
                          <input v-model="password" type="number" name="password" id="password" placeholder="Enter Your Password" class="input text-black w-full rounded-lg ">

                          <!-- <input v-model="password" type="number" name="password" id="password" placeholder="Enter Your Password" class="input text-black"> -->
                         </div>
